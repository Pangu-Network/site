...
const LazyIcon = defineAsyncComponent(() => import('./Icon-BMZassBJ.mjs').then((r) => r["default"] || r.default || r));
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-HW2aDf4_.mjs').then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: () => import('./default-CoAQZpOy.mjs').then((m) => m.default || m)
};
