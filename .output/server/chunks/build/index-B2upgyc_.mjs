...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs) {
  ...
  }, _attrs))} data-v-4e6b94ff><div class="flex flex-col md:items-end items-center justify-center md:h-[694px] z-10" data-v-4e6b94ff><div data-v-4e6b94ff><div class="md:text-6xl text-4xl font-bold" data-v-4e6b94ff>${ssrInterpolate(_ctx.$t("home.trust"))}</div><div class="md:text-6xl text-4xl font-bold text-bor tracking-tighter mt-2" data-v-4e6b94ff>idea to game</div><div class="md:text-6xl text-4xl font-bold mt-2" data-v-4e6b94ff>Made possible</div><div class="text-[#ccc] mt-8" data-v-4e6b94ff>Create your own customized game</div><button class="bnr-btn cursor-pointer mt-12 mb-4 bg-cover bg-no-repeat bg-center text-black hover:text-slate-700 text-xl font-bold w-[349px] h-[82px]" style="${ssrRenderStyle({ "background-image": "url('/img/home/btn-ng.png')" })}" data-v-4e6b94ff>Start Building</button></div></div><div class="flex flex-col justify-center z-10" data-v-4e6b94ff><div class="flex" data-v-4e6b94ff><div data-v-4e6b94ff>`);
  _push(ssrRenderComponent(_component_NuxtImg, {
    src: "/img/home/bnr-coin1.png",
    class: "w-[233px] h-auto coin1"
  }, null, _parent));
  _push(`</div><div class="ml-16 mt-12" data-v-4e6b94ff>`);
  _push(ssrRenderComponent(_component_NuxtImg, {
    src: "/img/home/bnr-coin2.png",
    class: "w-[80px] h-auto coin2"
  }, null, _parent));
  _push(`</div></div><div class="flex pl-24" data-v-4e6b94ff><div class="mt-16" data-v-4e6b94ff>`);
  _push(ssrRenderComponent(_component_NuxtImg, {
    src: "/img/home/bnr-coin3.png",
    class: "w-[74px] h-auto coin3"
  }, null, _parent));
  _push(`</div><div class="ml-28" data-v-4e6b94ff>`);
  _push(ssrRenderComponent(_component_NuxtImg, {
    src: "/img/home/bnr-coin4.png",
    class: "w-[178px] h-auto coin4"
  }, null, _parent));
  _push(`</div></div></div><div class="lines" data-v-4e6b94ff><!--[-->`);
  ssrRenderList(8, (i) => {
    _push(`<div data-v-4e6b94ff></div>`);
  });
  _push(`<!--]--></div></div>`);
}
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-4e6b94ff"]]);
const _sfc_main$3 = {};
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  const _component_NuxtImg = __nuxt_component_0$1;
  _push(`<section${ssrRenderAttrs(mergeProps({ class: "m-auto 2xl:w-[70%] md:w-[80%] w-[90%] py-12 pt-24 overflow-hidden" }, _attrs))} data-v-7a40d52e><div class="md:text-4xl text-2xl font-bold mb-8" data-v-7a40d52e>${ssrInterpolate(_ctx.$t("home.howItWorks"))}</div><div class="bg-[#161616] md:p-20 p-4 grid md:grid-cols-3 grid-cols-1 md:gap-x-12 md:gap-y-24" data-v-7a40d52e><div class="md:w-[23vw] w-full" data-v-7a40d52e>`);
  _push(ssrRenderComponent(_component_NuxtImg, {
    src: "/img/home/one.png",
    class: "w-8/12 h-auto bottom-scroll-animation"
  }, null, _parent));
  _push(`</div><div class="flex flex-col justify-center sm:col-span-2 pr-6 right-scroll-animation" data-v-7a40d52e><div class="wtit" data-v-7a40d52e>Idea</div><div class="text-base mt-6 md:mb-4 mb-8" data-v-7a40d52e>Bring forth any creative idea that flashes through your mind. Whether a brief description or a set of keywords, they are the keys to unlock this magical journey. No technical background is needed\u2014just your imagination.</div></div><div class="flex flex-col justify-center sm:col-span-2 md:pl-12 left-scroll-animation" data-v-7a40d52e><div class="wtit" data-v-7a40d52e>AI Design</div><div class="text-base mt-6 md:mb-4 mb-8" data-v-7a40d52e>AI will suggest design elements such as the game&#39;s visual style, interface layout, and narrative interactions based on your creativity. AI will generate multiple design proposals for you to choose from or provide further feedback on, ensuring the final design meets your expectations precisely.</div></div>`);
  _push(ssrRenderComponent(_component_NuxtImg, {
  ...
  _push(`<div class="flex flex-col justify-center sm:col-span-2 pr-6 right-scroll-animation" data-v-7a40d52e><div class="wtit" data-v-7a40d52e>AI Dev</div><div class="text-base mt-6 md:mb-4 mb-8" data-v-7a40d52e>Once the design is confirmed, the AI development phase will commence. In this stage, artificial intelligence will take on the heavy lifting of coding, transforming the design concepts into actual game code.</div></div><div class="flex flex-col justify-center sm:col-span-2 md:pl-12 left-scroll-animation" data-v-7a40d52e><div class="wtit" data-v-7a40d52e>AI Iteration</div><div class="text-base mt-6 md:mb-4 mb-8" data-v-7a40d52e>After the first playable version of the game is completed, AI can use self-learning or your feedback to improve and optimize the game. Whether adjusting difficulty balance, enhancing user experience, or adding new content, AI can respond quickly, continuously elevating the quality of the game.</div></div>`);
  _push(ssrRenderComponent(_component_NuxtImg, {
  ...
  _push(`<div class="flex flex-col justify-center sm:col-span-2 pr-6 right-scroll-animation" data-v-7a40d52e><div class="wtit" data-v-7a40d52e>AI Testing</div><div class="text-base mt-6 md:mb-4 mb-8" data-v-7a40d52e>During the AI testing phase, artificial intelligence will conduct comprehensive testing of the game. AI can simulate different gaming scenarios, locate and fix issues and bugs, ensuring game stability and fluidity.</div></div><div class="flex flex-col justify-center sm:col-span-2 md:pl-12 left-scroll-animation" data-v-7a40d52e><div class="wtit" data-v-7a40d52e>Game Delivery</div><div class="text-base mt-6 md:mb-4 mb-8" data-v-7a40d52e>Games that pass testing will be directly run on cloud platforms for players to experience or share. Moreover, AI can also provide subsequent updates and maintenance services as needed, ensuring a continuously optimized gaming experience.</div></div><div class="md:w-[23vw] w-full" data-v-7a40d52e>`);
  _push(ssrRenderComponent(_component_NuxtImg, {
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-7a40d52e"]]);
const _sfc_main$2 = {
  __name: "ourInvestors",
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-b1da2707"]]);
...
//# sourceMappingURL=index-B2upgyc_.mjs.map
