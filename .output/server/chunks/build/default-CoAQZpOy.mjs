...
import __nuxt_component_1$1 from './Icon-BMZassBJ.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex items-center px-1 2xl:ml-64 xl:ml-48 lg:ml-32 md:ml-16 ml-4"${_scopeId}><img${ssrRenderAttr("src", _imports_0)} alt="Logo" class="h-[42px]"${_scopeId}></div>`);
          } else {
            return [
      ...
      _push(`<nav class="hidden lg:flex"><!--[-->`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_Icon, {
              ...
              size: "20",
              class: "mr-12 cursor-pointer hover:text-[#8affd4]"
            }, null, _parent2, _scopeId));
          } else {
            return [
      ...
      _push(`<button class="lg:hidden mr-4"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16m-7 6h7"></path></svg></button>`);
      if (unref(isOpen)) {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_NuxtImg = __nuxt_component_0$1;
  const _component_Icon = __nuxt_component_1$1;
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "text-[#666666] bg-black pt-14" }, _attrs))}><div class="px-6 md:w-[70%] w-[90%] mx-auto"><div class="grid md:grid-cols-3 grid-cols-1"><div class="md:pb-14 pb-4">`);
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="gd-container font-mono" data-v-f52adece><header class="${ssrRenderClass([{ "skicy": unref(scrollTop) > 500 }, "fixed w-full z-10"])}" data-v-f52adece>`);
      _push(ssrRenderComponent(_component_MainHeader, null, null, _parent));
      _push(`</header><main class="pt-28 mmm" style="${ssrRenderStyle({ "z-index": "1" })}" data-v-f52adece>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</main><footer data-v-f52adece>`);
...
//# sourceMappingURL=default-CoAQZpOy.mjs.map
